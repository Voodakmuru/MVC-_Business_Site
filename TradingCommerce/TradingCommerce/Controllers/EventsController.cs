...
namespace TradingCommerce.Controllers
{
    public class EventsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "eventID,details,businessID")] Event @event)
        {
            ...
            ViewBag.businessID = new SelectList(db.Businesses, "businessID", "businessName", @event.businessID);
            return View(@event);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "eventID,details,businessID")] Event @event)
        {
            if (ModelState.IsValid)
            {
